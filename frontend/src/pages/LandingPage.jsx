...
import { FaCalendarCheck, FaRobot, FaUserMd, FaQuoteLeft, FaStar } from "react-icons/fa";
...
export default function LandingPage() {
  ...
  return (
    <div className="bg-blue-50 min-h-screen font-sans">
        ...
        <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-between relative z-10 gap-12 md:gap-20">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <h1 className="text-5xl font-extrabold mb-6 drop-shadow-lg leading-tight text-gray-900">
              Book Appointment With <span className="text-blue-600">Trusted Doctors</span>
            </h1>
            <p className="text-lg mb-6 text-gray-700">
              Browse through our extensive list of expert doctors and schedule your appointment hassle-free.
            </p>
      ...
      <section className="py-16 px-5 text-center bg-white">
        <h2 className="text-3xl font-bold text-blue-600 mb-10">Why Choose Us?</h2>
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <FeatureCard icon={<FaCalendarCheck />} title="Easy Appointments" text="Book and manage appointments seamlessly." countStart={50000} countEnd={100000} />
          <FeatureCard icon={<FaRobot />} title="AI Assistance" text="Get instant AI-driven medical guidance." countStart={1000} countEnd={5000} />
          <FeatureCard icon={<FaUserMd />} title="Trusted Doctors" text="Find top-rated doctors near you." countStart={200} countEnd={500} />
        </div>
      </section>
  ...
  >
    <SwiperSlide><ReviewCard index={0} name="Dr. Sharma" role="Doctor" text="This platform has helped me connect with more patients than ever!" /></SwiperSlide>
    <SwiperSlide><ReviewCard index={1} name="Ravi Patel" role="Patient" text="The AI assistant helped me understand my symptoms before my appointment." /></SwiperSlide>
    <SwiperSlide><ReviewCard index={2} name="Priya Mehta" role="Patient" text="Booking an appointment was super easy and fast!" /></SwiperSlide>
    <SwiperSlide><ReviewCard index={3} name="Dr. Verma" role="Doctor" text="A great platform for doctors to manage their appointments." /></SwiperSlide>
    <SwiperSlide><ReviewCard index={4} name="Ananya Singh" role="Patient" text="I found the best doctor for my health concerns through this app!" /></SwiperSlide>
    <SwiperSlide><ReviewCard index={5} name="Dr. Gupta" role="Doctor" text="A seamless experience for both doctors and patients alike!" /></SwiperSlide>
  </Swiper>
</section>
